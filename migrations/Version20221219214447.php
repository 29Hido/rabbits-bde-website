 ...
 */
final class Version20221219214447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, captain_id INT NOT NULL, name VARCHAR(255) NOT NULL, games LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', creation_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_C4E0A61F3346729B (captain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
